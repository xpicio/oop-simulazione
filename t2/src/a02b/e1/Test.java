 ...
 * degli helper (factory e trasformatori) per Cursor, che a sua volta modella un
 * cursore,
...
public class Test {
	...
	public void testToList() {
		...
		// lista ottenuta dai primi 7 elementi del cursore, che sono troppi, quindi
		// prendi i 5 del cursore
